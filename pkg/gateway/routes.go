...
// hostnamesOverlap reports whether two hostname lists share any intersecting name.
...
// routePrecedenceWins reports whether a should be preferred over b when two
// routes of different types compete for the same hostname. Oldest creation
// timestamp wins, then "{namespace}/{name}" alphabetical order.
